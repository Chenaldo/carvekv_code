            ...
            if _is_first_prefill:
                ...
                if _eviction_mode == 'committee' and self.layer_idx == D:
                    ...
                    if _agg_info is not None:
                        ...
                        # Trim layers 0..D (including the decision layer).
                        # Layers after D have not finished cache update for this chunk,
                        # so full-sequence indices in keep_indices would be out of range.
